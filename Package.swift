...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ContentsquareSDK",
            url: "https://github.com/ContentSquare/apple-sdk-prereleases/releases/download/0.0.102-rc.4/package.zip",
            checksum: "b585ddfe11f21cc46b5ff547bf41b0ec6d9d33e56803d9fec0087cbb8bdcc359"
        ),
    ],
