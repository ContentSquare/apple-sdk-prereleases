...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ContentsquareSDK",
            url: "https://github.com/ContentSquare/apple-sdk-prereleases/releases/download/0.0.102-rc.3/package.zip",
            checksum: "ff24f125e61ab8333e1569efc74833769f936e7f042645d1c9bb03d4f221d970"
        ),
    ],
