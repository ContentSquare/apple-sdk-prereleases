...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ContentsquareSDK",
            url: "https://github.com/ContentSquare/apple-sdk-prereleases/releases/download/0.0.102-rc.1/package.zip",
            checksum: "43d9c6bfee04f4e640557a7820770ffcfbae2fb1a85f243a6710e137199bd0ed"
        ),
    ],
