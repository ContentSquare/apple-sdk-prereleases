...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/heap/heap-ios-cs-integration-sdk.git", exact: "0.9.0-rc.2"),
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ContentsquareSDK",
            url: "https://github.com/ContentSquare/apple-sdk-prereleases/releases/download/1.0.0-rc.25/package.zip",
            checksum: "8699ff2befd55459bb562ae27d56b73da6907941b0e9fdecfbe050f5610a4770"
        ),
    ],
