...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ContentsquareSDK",
            url: "https://github.com/ContentSquare/apple-sdk-prereleases/releases/download/0.0.102-rc.5/package.zip",
            checksum: "a18649fe4427c8a54274d18bd8cb490c8f0e0f2b82878c0b698cfb1d9110cd9c"
        ),
    ],
