...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ContentsquareSDK",
            url: "https://github.com/ContentSquare/apple-sdk-prereleases/releases/download/1.0.0-rc.28/package.zip",
            checksum: "51507bcd5895a879d63349b8196fe01d1db862bfad7c0e5e8afc2699492960f6"
        ),
    ],
