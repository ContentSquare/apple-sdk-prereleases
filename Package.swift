...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ContentsquareSDK",
            url: "https://github.com/ContentSquare/apple-sdk-prereleases/releases/download/0.0.102-rc.7/package.zip",
            checksum: "6575cb23678596588ab6f1f3774c71f1f7653302bdeb05215b9467283c95150a"
        ),
    ],
