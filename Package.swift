...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ContentsquareSDK",
            url: "https://github.com/ContentSquare/apple-sdk-prereleases/releases/download/1.0.0-rc.18/package.zip",
            checksum: "e60dffc3fb6a86b2985219f063ebcced1d01cc6c71bbb1c4e60f6aff59ac1b09"
        ),
    ],
